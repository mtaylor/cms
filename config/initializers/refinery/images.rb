...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:thumbnail => "50x50", :small=>"110x110>", :medium=>"225x255>", :large=>"450x450>"}
  ...
  # config.dragonfly_secret = "9e457aeef75a48f0b41c0b43a4dd7c1bf2b9ddde94f9a558"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/home/martyn/dev/cms/public/system/refinery/images"
